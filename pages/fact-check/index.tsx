...
const FactCheckPage = () => {
  // تاریخ فرضی برای راه‌اندازی سامانه راستی‌آزمایی (۲۱ روز دیگر)
  ...
  return (
    <>
      <Head>
        <title>راستی‌آزمایی - به زودی</title>
        <meta name="description" content="سامانه راستی‌آزمایی پناهگاه امن به زودی راه‌اندازی خواهد شد." />
      </Head>
      ...
      <ComingSoonContainer>
        ...
        <Description>
          سامانه راستی‌آزمایی اخبار و اطلاعات مرتبط با بحران در حال توسعه است و به زودی راه‌اندازی خواهد شد.
          با این سامانه می‌توانید صحت اخبار دریافتی را بررسی کنید و از انتشار شایعات جلوگیری کنید.
        </Description>
